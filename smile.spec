...
a = Analysis(
    ...
    hiddenimports=['smile.compiler', 'smile.errors', 'smile.stdlib', 'smile.pypi_fetch', 'smile.lowlevel', 'smile.debugger', 'smile.lsp', 'smile.web', 'smile.gpu', 'smile.ffi', 'smile.compute', 'smile.gui', 'lark'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
